...
export class BatchService {
  ...
  public newGetMenuContentsUpdates({ menuIds, dishIds, day, change }: {
    menuIds: string[],
    dishIds: string[],
    day?: Day,
    change?: 'add' | 'remove',
  ...
  public newGetMealUpdates({ key, initialMealIds, finalMealIds, entityId }: {
    key: 'dishes' | 'tags',
  ...
  public newGetDishUpdates({ key, initialDishIds, finalDishIds, entityId }: {
    key: 'meals' | 'tags',
  ...
  public newGetDishCountersUpdates({ dishIds, menu, change }: {
    dishIds: string[],
    menu: Menu,
  ...
  public newGetTagUpdates({ key, initialTagIds, finalTagIds, entityId }: {
    key: 'meals' | 'dishes',
